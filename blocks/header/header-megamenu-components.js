...
import { img, div, a } from '../../scripts/dom-helpers.js';
...
async function buildBlogCardSubmenu(featuredPost) {
  const blogPostLinks = [];
  const featuredPostUrl = featuredPost.querySelector('a').getAttribute('href');
  const allPostCol = div();
