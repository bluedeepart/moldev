...
export default async function decorate(block) {
  ...
  block.children[0].children[0].appendChild(
    document.createRange().createContextualFragment(searchMainSection()),
  );
  new Promise(() => {
    loadCSS('https://static.cloud.coveo.com/searchui/v2.10104/css/CoveoFullSearch.min.css');
  });
  loadScript(
    'https://static.cloud.coveo.com/searchui/v2.10104/js/CoveoJsSearch.Lazy.min.js',
    null,
    null,
    true,
  );
  loadScript(
    'https://static.cloud.coveo.com/searchui/v2.10104/js/templates/templates.js',
    null,
    null,
    true,
  );
